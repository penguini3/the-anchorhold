...
Some things that I'm currently working on! Anything that I make that's tech related is on my [Github](https://github.com/penguini3), and anything writing related will go up here if you want to see anything in detail.
...
- **Identity Management** ~ I think we're all familiar with the pain of long term internet use: having a million accounts and a million emails and never really knowing where everything is. Also this month, I want to sit down and properly organize my digital infrastructure so that I don't end up with dozens of unread emails in my school email because I didn't know where to find the password or if I had set up forwarding. Again.
- **Blogging** ~ I want to post about the stuff I'm up to and various reviews here! Largely because otherwise I'll end up just yapping about whatever's caught my fancy to Everyone I talk to regularly in realspace. 
